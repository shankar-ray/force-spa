...
@ContextConfiguration(locations = {"classpath:com/force/spa/jersey/springDefaultInjectionContext.xml"})
public class SpringDefaultInjectionTest extends AbstractJUnit4SpringContextTests {
